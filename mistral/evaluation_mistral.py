...
def build_evaluate_response_prompt(
    subtheme: str,
    question: str,
    response: str,
    lang: str | None = None,
) -> str:
    return prompt_prefix(lang) + f"""
...
async def evaluate_response_with_mistral(
    subtheme: str,
    question: str,
    response: str,
    lang: str | None = None,
    ...
    prompt = build_evaluate_response_prompt(subtheme, question, response, lang)
